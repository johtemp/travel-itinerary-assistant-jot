...
function generateTravel(event) {
  ...
  let context =
    "You are a travel itinerary planner who has information about cities and countries all over the world. Include activities and places to eat. Make sure to include the city name on each day. Use HTML tags for formatting text. Your mission is to generate a 5 line intinerary for 5 days. Separate each day for the itinerary with 2 line breaks <br/> Have the word Day and the city in <strong>. If you do not recognise the city respond with I don't recognise this city, please try again in one line.";
